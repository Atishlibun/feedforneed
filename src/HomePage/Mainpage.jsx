    ...
    <div>
      <div className="container-fluid">
        <h1
          ...
          style={{ fontSize: "8vw", color: "white", paddingTop: "80px" }}
        >
          FEED FOR NEED
        </h1>
        <br />
        ...
        >
          Today, 690 million people around the world will go to bed on an empty
          stomach. But your gift means that one less child will be at risk of
          starvation tonight. Whether you decide to make a one-off donation or
          set up a monthly gift, you can change a life forever today. Often, one
          meal at the right time will be enough to make a difference between
          life and death. Lorem ipsum dolor sit amet, consectetur adipisicing
          elit. Dignissimos quibusdam repellendus dolore adipisci, doloremque,
          distinctio fugit earum impedit ut et quisquam, laboriosam ex fugiat
          facilis nostrum omnis. Iste, est adipisci.
        </h3>
        <br />
        <br />
        <br />
      ...
      <div class="card-deck">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              As soon as you complete your donation, your gift will start its
              journey. First your money will be turned into food, and then sent
              to one of the over 80 countries where people are most vulnerable.
              Every single day, FFN has 5,600 trucks, 30 ships and nearly 100
              planes ready to deliver the food you send. Because you can't go
              there and hand out the food yourself, we do it for you. Please
              send food to save a life today and join the fight against hunger.
            </p>
          </div>
        </div>
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              Hunger is defined as a condition in which a person does not have
              the physical or financial capability to eat sufficient food to
              meet basic nutritional needs for a sustained period. In the field
              of hunger relief, the term hunger is used in a sense that goes
              beyond the common desire for food that all humans experience, also
              known as an appetite. The most extreme form of hunger, when
              malnutrition is widespread, and when people have started dying of
              starvation through lack of access to sufficient, nutritious food,
              leads to a declaration of famine
            </p>
          </div>
        </div>
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              ...
              quia tenetur nihil! Doloribus illum at vel deleniti. Consectetur,
              delectus neque dolore provident voluptates expedita! Temporibus
              voluptas hic laudantium sint natus corporis provident
              exercitationem voluptatem quia. Esse, asperiores? Vel, possimus
              dolore molestias sunt aspernatur officia debitis rem autem harum?
              Sequi voluptatem, ad doloribus similique amet sint eos earum
              distinctio porro.
            </p>
          </div>
        </div>
